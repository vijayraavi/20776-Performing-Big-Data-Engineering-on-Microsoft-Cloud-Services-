...
5.  In App.config, in the **appSettings** section, replace the **Endpoint** value **YourNamespace** with **camerafeeds*&lt;your name&gt;&lt;date&gt;***.
...
1.  Switch to the Azure portal, click **All resources**, and then click **adls*&lt;your name&gt;&lt;date&gt;***.
2.  On the **adls*&lt;your name&gt;&lt;date&gt;*** blade, click **Data Explorer**.
3.  On the **adls*&lt;your name&gt;&lt;date&gt;*** blade, click **SpeedData**, and then click all the subfolders.
...
2.  On the **IoT Hub** blade, in the **Name** box, type **patrolcars*&lt;your name&gt;&lt;date&gt;***.
...
7.  Click **All Resources**, and then click **patrolcars*&lt;your name&gt;&lt;date&gt;***.
8.  On the **patrolcars*&lt;your name&gt;&lt;date&gt;*** blade, under **MESSAGING**, click **Endpoints**, and then in the **Built-in** **endpoints** section, click **Events**.
...
11. On the **patrolcars*&lt;your name&gt;&lt;date&gt;* - Endpoints** blade, click **Overview**.
12. On the **patrolcars*&lt;your name&gt;&lt;date&gt;*** blade, click the **Hostname**, and click the **Click to copy** button, to copy the string to the clipboard.
...
16. Switch to the Azure portal, and on the **patrolcars*&lt;your name&gt;&lt;date&gt;*** blade, under **SETTINGS**, click **Shared access policies**.
...
4.  In Solution Explorer, double-click **App.config**.
5.  In App.config, in the **appSettings** section, in the **IoTHubConnectionString** and **IotHubUri** values, replace **YourIoTHub** with **patrolcars*&lt;your name&gt;&lt;date&gt;***.
...
1.  Switch to the Azure portal, click **All resources**, and then click **adls*&lt;your name&gt;&lt;date&gt;***.
2.  On the **adls*&lt;your name&gt;&lt;date&gt;*** blade, click **Data Explorer**.
3.  On the **adls*&lt;your name&gt;&lt;date&gt;*** blade, click **PatrolCarData**, and then click all the subfolders.
...
2.  On the **Create namespace** blade, in the **Name** box, type **locationalerts*&lt;your name&gt;&lt;date&gt;***.
3.  Under **Resource group**, click **Use existing**, and then click **CamerasRG**.
...
6.  Click **All resources**, and then click **locationalerts*&lt;your name&gt;&lt;date&gt;***.
7.  On the **locationalerts*&lt;your name&gt;&lt;date&gt;*** blade, under **SETTINGS**, click **Shared access policies**, and then click **RootManageSharedAccessKey**.
...
14. On the **locationalerts*&lt;your name&gt;&lt;date&gt;* - Shared access policies** blade, under **ENTITIES**, click **Queues**.
15. On the **locationalerts*&lt;your name&gt;&lt;date&gt;* - Queues** blade, click **+ Queue**.
...
1.  Click **All resources**, and then click **patrolcars*&lt;your name&gt;&lt;date&gt;***.
2.  On the **patrolcars*&lt;your name&gt;&lt;date&gt;*** blade, under **MESSAGING**, click **Endpoints**.
3.  On the **patrolcars*&lt;your name&gt;&lt;date&gt;* - Endpoints** blade, under **Built-in endpoints**, click **Events**.
...
3.  On the **Create storage account** blade, in the **Name** box, type **datastore*&lt;your name&gt;&lt;date&gt;***.
4.  Under **Resource group**, click **Use existing**, and then click **CamerasRG**.
...
8.  Click **All resources**, and then click **datastore*&lt;your name&gt;&lt;date&gt;***.
9.  On the **datastore*&lt;your name&gt;&lt;date&gt;*** blade, under **BLOB SERVICE**, click **Containers**.
10. On the **datastore*&lt;your name&gt;&lt;date&gt;* - Containers** blade, click **+ Container**.
...
5.  Under your Azure Learning Pass subscription, under **Storage Accounts**, expand **datastore*&lt;your name&gt;&lt;date&gt;***.
...
1.  In Microsoft Azure, click **All resources**, and then click **camerafeeds*&lt;your name&gt;&lt;date&gt;***.
...
1.  Switch to the Azure portal, click **All resources**, and then click **adls*&lt;your name&gt;&lt;date&gt;***.
2.  On the **adls*&lt;your name&gt;&lt;date&gt;*** blade, click **Data Explorer**.
3.  On the **adls*&lt;your name&gt;&lt;date&gt;*** blade, click **StolenCarObservations**, and then click all the subfolders.
4.  Click the log file to view the contents in File Preview; verify that the data includes the fields you specified in your Azure Stream Analytics query.
...
1.  In the Azure portal, click **All resources**, and then click **locationalerts*&lt;your name&gt;&lt;date&gt;***.
2.  On the **locationalerts*&lt;your name&gt;&lt;date&gt;*** blade, under **ENTITIES**, click **Topics**, and then click **+ Topic**.
3.  On the **Create topic** blade, in the **Name** box, type **stolencaralerts**, and then click **Create**.
4.  On the **locationalerts*&lt;your name&gt;&lt;date&gt;* - Topics** blade, click **stolencaralerts**, and then click **+ Subscription**.
...
1.  Click **All resources**, and then click **patrolcars*&lt;your name&gt;&lt;date&gt;***.
2.  On the **patrolcars*&lt;your name&gt;&lt;date&gt;*** blade, under **MESSAGING**, click **Endpoints**, and then click **Events**.
...
8.  In App.config, in the **appSettings** section, in the **ServiceBusConnectionString** key, replace **YourServiceBusName** with **locationalerts*&lt;your name&gt;&lt;date&gt;***, and replace **YourServiceBusPrimaryKey** with the primary key you copied to **Config\_details.txt**.
9.  In App.config, in the **appSettings** section, in the **IoTHubConnectionString** and **IotHubUri** keys, replace **YourNamespace** with **patrolcars*&lt;your name&gt;&lt;date&gt;***.
