...
6.  On the **New Data Lake Store** blade, in the **Name** box, type **adls_&lt;your name&gt;&lt;date&gt;_**.
...
2.  On the **Create namespace** blade, in the **Name** box, type **camerafeeds_&lt;your name&gt;&lt;date&gt;_**.
...
7.  Click **All resources**, click **camerafeeds_&lt;your name&gt;&lt;date&gt;_**, and then click **+ Event Hub**.
...
12. On the **camerafeeds_&lt;your name&gt;&lt;date&gt;_** blade, under **ENTITIES**, click **Event Hubs**, and then click **traffic**.
...
18. On the **camerafeeds_&lt;your name&gt;&lt;date&gt;_ - Event Hubs** blade, under **SETTINGS**, click **Shared access policies**, and then click **RootManageSharedAccessKey**.
...
3.  On the **New input** blade, enter the following details:
 ...
 -   **Service bus namespace**: camerafeeds_&lt;your name&gt;&lt;date&gt;_ as you created earlier
...
5.  In App.config, in the **appSettings** section, replace the **Endpoint** value **YourNamespace** with **camerafeeds_&lt;your name&gt;&lt;date&gt;_**.
...
2.  On the **adls_&lt;your name&gt;&lt;date&gt;_** blade, click **Data Explorer**.
3.  On the **adls_&lt;your name&gt;&lt;date&gt;_** blade, click **SpeedData**, and then click all the subfolders.
...
2.  On the **IoT Hub** blade, in the **Name** box, type **patrolcars_&lt;your name&gt;&lt;date&gt;_**.
...
7.  Click **All Resources**, and then click **patrolcars_&lt;your name&gt;&lt;date&gt;_**.
8.  On the **patrolcars_&lt;your name&gt;&lt;date&gt;_** blade, under **MESSAGING**, click **Endpoints**, and then in the **Built-in** **endpoints** section, click **Events**.
...
11. On the **patrolcars_&lt;your name&gt;&lt;date&gt;_ - Endpoints** blade, click **Overview**.
12. On the **patrolcars_&lt;your name&gt;&lt;date&gt;_** blade, click the **Hostname**, and click the **Click to copy** button, to copy the string to the clipboard.
...
16. Switch to the Azure portal, and on the **patrolcars_&lt;your name&gt;&lt;date&gt;_** blade, under **SETTINGS**, click **Shared access policies**.
...
4.  In Solution Explorer, double-click **App.config**.
5.  In App.config, in the **appSettings** section, in the **IoTHubConnectionString** and **IotHubUri** values, replace **YourIoTHub** with **patrolcars_&lt;your name&gt;&lt;date&gt;_**.
...
1.  Switch to the Azure portal, click **All resources**, and then click **adls_&lt;your name&gt;&lt;date&gt;_**.
2.  On the **adls_&lt;your name&gt;&lt;date&gt;_** blade, click **Data Explorer**.
3.  On the **adls_&lt;your name&gt;&lt;date&gt;_** blade, click **PatrolCarData**, and then click all the subfolders.
...
2.  On the **Create namespace** blade, in the **Name** box, type **locationalerts_&lt;your name&gt;&lt;date&gt;_**.
3.  Under **Resource group**, click **Use existing**, and then click **CamerasRG**.
...
6.  Click **All resources**, and then click **locationalerts_&lt;your name&gt;&lt;date&gt;_**.
7.  On the **locationalerts_&lt;your name&gt;&lt;date&gt;_** blade, under **SETTINGS**, click **Shared access policies**, and then click **RootManageSharedAccessKey**.
...
14. On the **locationalerts_&lt;your name&gt;&lt;date&gt;_ - Shared access policies** blade, under **ENTITIES**, click **Queues**.
15. On the **locationalerts_&lt;your name&gt;&lt;date&gt;_ - Queues** blade, click **+ Queue**.
...
1.  Click **All resources**, and then click **patrolcars_&lt;your name&gt;&lt;date&gt;_**.
2.  On the **patrolcars_&lt;your name&gt;&lt;date&gt;_** blade, under **MESSAGING**, click **Endpoints**.
3.  On the **patrolcars_&lt;your name&gt;&lt;date&gt;_ - Endpoints** blade, under **Built-in endpoints**, click **Events**.
...
5.  In ConfigSettings.txt, replace **YourServiceBusName** with **locationalerts_&lt;your name&gt;&lt;date&gt;_**.
...
3.  On the **Create storage account** blade, in the **Name** box, type **datastore_&lt;your name&gt;&lt;date&gt;_**.
4.  Under **Resource group**, click **Use existing**, and then click **CamerasRG**.
...
8.  Click **All resources**, and then click **datastore_&lt;your name&gt;&lt;date&gt;_**.
9.  On the **datastore_&lt;your name&gt;&lt;date&gt;_** blade, under **BLOB SERVICE**, click **Containers**.
10. On the **datastore_&lt;your name&gt;&lt;date&gt;_ - Containers** blade, click **+ Container**.
...
5.  Under your Azure Learning Pass subscription, under **Storage Accounts**, expand **datastore_&lt;your name&gt;&lt;date&gt;_**.
...
1.  In Microsoft Azure, click **All resources**, and then click **camerafeeds_&lt;your name&gt;&lt;date&gt;_**.
2.  On the **camerafeeds_&lt;your name&gt;&lt;date&gt;_** blade, under **ENTITIES**, click **Event Hubs**, and then click **traffic**.
...
1.  Switch to the Azure portal, click **All resources**, and then click **adls_&lt;your name&gt;&lt;date&gt;_**.
2.  On the **adls_&lt;your name&gt;&lt;date&gt;_** blade, click **Data Explorer**.
3.  On the **adls_&lt;your name&gt;&lt;date&gt;_** blade, click **StolenCarObservations**, and then click all the subfolders.
4.  Click the log file to view the contents in File Preview; verify that the data includes the fields you specified in your Azure Stream Analytics query.
...
1.  In the Azure portal, click **All resources**, and then click **locationalerts_&lt;your name&gt;&lt;date&gt;_**.
2.  On the **locationalerts_&lt;your name&gt;&lt;date&gt;_** blade, under **ENTITIES**, click **Topics**, and then click **+ Topic**.
3.  On the **Create topic** blade, in the **Name** box, type **stolencaralerts**, and then click **Create**.
4.  On the **locationalerts_&lt;your name&gt;&lt;date&gt;_ - Topics** blade, click **stolencaralerts**, and then click **+ Subscription**.
...
1.  Click **All resources**, and then click **patrolcars_&lt;your name&gt;&lt;date&gt;_**.
2.  On the **patrolcars_&lt;your name&gt;&lt;date&gt;_** blade, under **MESSAGING**, click **Endpoints**, and then click **Events**.
...
1.  Click **All resources**, and then click **camerafeeds_&lt;your name&gt;&lt;date&gt;_**.
2.  On the **camerafeeds_&lt;your name&gt;&lt;date&gt;_** blade, under **ENTITIES**, click **Event Hubs**, and then click **traffic**.
3.  On the **traffic** blade, click **+ Consumer Group**.
...
8.  In App.config, in the **appSettings** section, in the **ServiceBusConnectionString** key, replace **YourServiceBusName** with **locationalerts_&lt;your name&gt;&lt;date&gt;_**, and replace **YourServiceBusPrimaryKey** with the primary key you copied to **Config\_details.txt**.
9.  In App.config, in the **appSettings** section, in the **IoTHubConnectionString** and **IotHubUri** keys, replace **YourNamespace** with **patrolcars_&lt;your name&gt;&lt;date&gt;_**.
